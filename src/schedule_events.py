...
def schedule_tasks_for_event(event_id, start_time, end_time, scoreboard_interval=DEFAULT_SCOREBOARD_INTERVAL):
    ...
    # ... (omitted discord notifications, which are fine)
    ...
    # -------------------------------------------------------------------
    # FIX: Scoreboard Display Tasks
    # The default for scoreboard_interval now comes from the .env file.
    # -------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------
    # ... (omitted remaining tasks)
    
    # Notify results (5 minutes after end)
